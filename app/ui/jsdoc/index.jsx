      ...
      <div className='jsdoc'>
        ...
        <section>
          ...
          {docContent.description ?
            <Markdown value={docContent.description} /> : null}
        </section>
        ...
        {docContent.returns ?
          this._renderReturnsSection(docContent.returns) : null}

        {docContent.exceptions ?
          this._renderExceptionsSection(docContent.exceptions) : null}

        {docContent.examples ?
          this._renderExamplesSection(docContent.examples) : null}
      </div>
    );
  }
